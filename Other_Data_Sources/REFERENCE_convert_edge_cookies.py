...
SOURCE: /Users/admin/ERA_Admin/FathomInventory/scripts/convert_edge_cookies.py
PROVEN: Production use in FathomInventory since October 2025
STATUS: Stable reference implementation

TO USE:
1. Copy this file to your project
2. Adapt output filename and domain as needed
3. Keep core conversion logic intact
